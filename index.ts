...
if (answer.operator === "Addition (+)") {
  console.log(
    `Your answer of ${answer.Firstnumber} + ${answer.Secondnumber} is : ${
      totalp
    }`
  );
  ...
  console.log(
    `Your answer of ${answer.Firstnumber} X ${answer.Secondnumber} is : ${
      totalm
    }`
  );
...
if (answer){const answer2 = await inquirer.prompt([
  {message: "Can you want more calculation",type: "list",name:"chioces",choices:["Yes","No"]},
...
if (answer){const answer3 = await inquirer.prompt([
  {message: "Can you want more calculation",type: "list",name:"chioces",choices:["Yes","No"]},
...
if (answer){const answer = await inquirer.prompt([
  {message: "Can you want more calculation",type: "list",name:"chioces",choices:["Yes","No"]},
...
if (answer.chioces === "no"){
  console.log("thanks bhai, kafi coding karli ab koi or mini project banata hon")
}